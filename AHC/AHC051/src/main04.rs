...
fn main() {
    ...
    for perm in (0..N).permutations(N) {
        ...
        // println!("Processing permutation: {:?}", perm);
        // permに基づいてprocessorの入れ替えを行う
        let mut inner_best_output = output.clone();
        inner_best_output.ds = perm.clone();
        ...
        while let Some(u) = queue.pop_front() {
            ...
            for i in 0..K {
                ...
                if !visited[current_v2] {
                    ...
                    // v1とv2の入れ替え
                    let mut new_output = inner_best_output.clone();
